	...
	public class Pixelize : MonoBehaviour
	{
		...
		private Shader ScreenAndMaskShader
		{
			get
			{
				...
				{
					_screenAndMaskShader = Shader.Find("Hidden/AmplifyShaderPack/Community/VolumetricPixelizationScreenAndMask");
				}
		...
		private Shader CombineLayersShader
		{
			get
			{
				...
				{
					_combineLayersShader = Shader.Find("Hidden/AmplifyShaderPack/Community/VolumetricPixelizationCombineLayers");
				}
